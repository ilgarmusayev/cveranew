    ...
    try {
        const browser = await puppeteer.launch({
            ...
            args: [
                ...
                '--disable-web-security',
                '--allow-running-insecure-content',
                // 🔧 PRODUCTION DA FONT RENDERING ÜÇÜN XÜSUSI PARAMETRLƏR
                '--force-color-profile=srgb',
                ...
                '--disable-renderer-backgrounding',
                '--disable-backgrounding-occluded-windows',
                // 🔧 FONT FALLBACK VƏ RENDERING OPTIMIZATION
                '--enable-font-antialiasing',
                '--font-render-hinting=none',
                '--force-device-scale-factor=1',
                '--force-color-profile=srgb'
        ...
        console.log('Browser başladıldı successfully with enhanced font support');
        return browser;
    } catch (browserError) {
        ...
        if (htmlContent && cssContent) {
            ...
            html = `
                ...
                <head>
                    ...
                    <style>
                        /* AZƏRBAYCAN HƏRFLƏRİ ÜÇÜN PRODUCTION-SAFE FONT SİSTEMİ */
                        /* Production da Google Fonts yüklənmədikdə fallback system */
                        
                        /* 🔧 STRONG FALLBACK FONTS FOR PRODUCTION */
                        * {
                            font-family: 
                                system-ui, 
                                -apple-system, 
                        ...
                        /* 🔧 TEXT ELEMENTS FONT ENFORCEMENT */
                        ...
                        /* 🔧 AZƏRBAYCAN HƏRFLƏRİ ÜÇÜN XÜSUSI DƏSTƏK */
                        [lang="az"], [lang="az-AZ"] {
                            font-family: 
                                system-ui, 
                                -apple-system, 
