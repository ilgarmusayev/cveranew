...
export default function LinkedInImportPage() {
  ...
  const labels = {
    ...
    russian: {
      pageTitle: 'Импорт Линкедин',
      pageSubtitle: 'Автоматически импортируйте свой профиль Линкедин и создайте профессиональное резюме за секунды',
      ...
      step1: 'Введите ссылку на Линкедин',
      ...
      enterLinkedInURL: 'Введите URL вашего профиля Линкедин',
      placeholder: 'https://www.linkedin.com/in/ваш-профиль',
      importButton: 'Импортировать из Линкедин',
      importing: 'Импорт...',
      exampleFormats: 'Правильные форматы:',
      errorEmptyURL: 'Пожалуйста, введите URL Линкедин',
      errorInvalidFormat: 'Пожалуйста, введите правильный формат URL Линкедин. Пример: https://www.linkedin.com/in/ilgarmusayev/',
