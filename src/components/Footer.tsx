...
export default function Footer() {
  ...
  const labels = {
    azerbaijani: {
      description: 'LinkedIn və Süni İntellekt ilə fərdiləşdirilmiş və yüksək keyfiyyətli CV yaradın, karyera yolunda uğur qazanın.',
      ...
      platform: 'LinkedIn və Süni İntellekt inteqrasiyalı CV yaratma platforması.'
    },
    english: {
      description: 'Create personalized and high-quality CVs with LinkedIn and AI integration to succeed in your career path.',
      followUs: 'Follow us:',
      services: 'Services',
      createCV: 'Create CV',
      coverLetter: 'Cover Letter',
    ...
    russian: {
      description: 'Создавайте профессиональные резюме с интеграцией Линкедин и поддержкой ИИ.',
      ...
      platform: 'Платформа создания резюме с интеграцией Линкедин и ИИ.'
    }
  };
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start gap-16 lg:gap-16">
              ...
              <div className="w-full lg:w-1/2">
                ...
                <div className="flex items-center space-x-4">
                  <span className="text-gray-600 text-xs sm:text-sm">{content.followUs}</span>
                  ...
                  <a
                      ...
                      title={siteLanguage === 'azerbaijani' ? "LinkedIn-də izləyin" : siteLanguage === 'english' ? "Follow on LinkedIn" : "Подписывайтесь в Линкедин"}
                  >
                  ...
                  <a
                      ...
                      title={siteLanguage === 'azerbaijani' ? "Instagram-da izləyin" : "Follow on Instagram"}
                  >
                    <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="w-full lg:w-1/2 grid grid-cols-2 gap-6 lg:flex lg:flex-row lg:justify-end lg:gap-10">
                ...
                {/* Ümumi */}
                <div className="text-left">
                  <h3 className="text-base lg:text-lg font-semibold text-gray-900 mb-3 lg:mb-6">{content.general}</h3>
                  <ul className="space-y-2 lg:space-y-4">
                    <li><Link href="/faq" className="text-gray-600 hover:text-blue-600 transition-colors duration-200 text-xs sm:text-sm lg:text-base">{content.faq}</Link></li>
                    <li><Link href="/terms" className="text-gray-600 hover:text-blue-600 transition-colors duration-200 text-xs sm:text-sm lg:text-base">{content.terms}</Link></li>
                    <li><Link href="/privacy" className="text-gray-600 hover:text-blue-600 transition-colors duration-200 text-xs sm:text-sm lg:text-base">{content.privacy}</Link></li>
                    <li><Link href="/contact" className="text-gray-600 hover:text-blue-600 transition-colors duration-200 text-xs sm:text-sm lg:text-base">{content.contact}</Link></li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="border-t border-gray-200 pt-10 mt-16">
              <div className="text-center">
                <p className="text-gray-500 text-sm mb-2">
                  © {new Date().getFullYear()} cvera.net | {content.copyright}
                </p>
