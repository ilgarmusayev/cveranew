...
export default function DashboardV2({ user, onEditCV }: DashboardV2Props) {
  ...
  const labels = {
    ...
    russian: {
      ...
      startCreatingEP: 'Начать',
      startCreating: 'Начать',
      myCVs: 'Мои резюме',
      created: 'Создано',
