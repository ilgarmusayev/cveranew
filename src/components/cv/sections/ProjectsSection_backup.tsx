              ...
              <div className="flex-1">
                ...
                {(project.startDate || project.endDate) && (
                    <p className="text-xs text-gray-500 mt-1">
                        {project.startDate} - {project.current ? 'Hal-hazırda davam edir' : project.endDate}
                    </p>
                )}
              ...
              {expandedId === project.id && (
                <div className="space-y-4 border-t border-gray-200 pt-4 mt-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        Layihə URL-i <span className="text-gray-400 text-xs">(ixtiyari)</span>
                      </label>
                      <input
                        type="url"
                        value={project.url || ''}
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        GitHub URL-i <span className="text-gray-400 text-xs">(ixtiyari)</span>
                      </label>
                      <input
                        type="url"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        Texnologiyalar <span className="text-gray-400 text-xs">(vergüllə ayırın)</span>
                      </label>
                      <input
                        type="text"
                  ...
                  <DateRangeInput
                    ...
                    currentLabel="Hal-hazırda layihədə işləyirəm"
                  />
