              ...
              <div className="flex-1">
                ...
                {experience.startDate && (
                  <p className="text-xs text-gray-500 mt-1">
                    {experience.startDate} - {experience.current ? 'Hal-hazırda davam edir' : experience.endDate}
                  </p>
                )}
              </div>
              ...
              {expandedId === experience.id && (
                <div className="space-y-4 border-t border-gray-200 pt-4 mt-4">
                  ...
                  <DateRangeInput
                    ...
                    onCurrentChange={(isCurrent) => updateExperience(experience.id, 'current', isCurrent)}
                    startLabel="Başlama tarixi"
                    endLabel="Bitmə tarixi"
                    currentLabel="Hal-hazırda burada işləyirəm"
                  />
