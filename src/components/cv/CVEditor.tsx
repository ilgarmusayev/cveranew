    ...
    <div className="block lg:hidden">
        ...
        <div className="fixed bottom-6 left-6 z-[60]">
            <button
                ...
                disabled={true}
                className="group relative bg-gradient-to-r from-gray-400 to-gray-500 cursor-not-allowed
            ...
            >
                ...
                <span>
                    {siteLanguage === 'azerbaijani' && 'Süni İntellekt ilə təkmilləşdirin (Çox yaxında)'}
                    {siteLanguage === 'english' && 'Improve with AI (Coming soon)'}
                    {siteLanguage === 'russian' && 'Улучшить с ИИ (Скоро)'}
                </span>
            </button>
        </div>
