...
export default function StandardHeader() {
  ...
  return (
    <header className="bg-gradient-to-r from-blue-600 to-blue-700 border-b border-blue-800 top-0 z-[100000] shadow-lg">
        ...
        <div className="flex justify-between items-center h-16 sm:h-18 md:h-20">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 lg:space-x-4">
            ...
            <div className="relative" data-language-menu>
              ...
              >
                <span className="mr-1 lg:mr-2 flex items-center">
                  <Image
                    src={getLanguageDisplay(siteLanguage).flag}
                    alt={getLanguageDisplay(siteLanguage).name}
                    width={20}
                    height={15}
                    className="rounded"
                  />
